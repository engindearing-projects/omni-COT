...
ZIP_NAME="omnicot-pipeline-$TIMESTAMP.zip"
...
# Create zip with omnicot root folder as required by TAK pipeline
# IMPORTANT: This must match rootProject.name in settings.gradle
